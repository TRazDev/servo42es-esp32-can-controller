...
**First power-up (24 V, no ESP32):** the motor holds its position (shaft locked). Explanation, confirmed later over CAN: the motor was already in mode 05 (bus closed-loop), and 8FH "lock shaft on bus-mode start" defaults to on.
